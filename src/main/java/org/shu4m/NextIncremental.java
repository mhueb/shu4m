...
public class NextIncremental extends AbstractVersionManipulator {
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    getLog().info("next incremental");
    Version version = Version.parseVersion(mavenProject.getVersion());
    Version newVersion = Version.toVersion(version.getMajor(), version.getMinor(), next(version.getIncremental()), version.getBuild(), version.getQualifier());
